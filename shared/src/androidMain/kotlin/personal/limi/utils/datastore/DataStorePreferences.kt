...
actual object DataStorePreferences : DataStorePreferencesHelper {
  ...
  private suspend inline fun <T> putValue(
    key: String,
    value: T,
    crossinline keyCreator: (String) -> Preferences.Key<T>,
  ) {
  ...
  private inline fun <T> putValueSync(
    key: String,
    value: T,
    crossinline keyCreator: (String) -> Preferences.Key<T>,
  ) {
  ...
  private suspend inline fun <T> getValue(
    key: String,
    defaultValue: T,
    crossinline keyCreator: (String) -> Preferences.Key<T>,
  ): T {
  ...
  private inline fun <T> getValueSync(
    key: String,
    defaultValue: T,
    crossinline keyCreator: (String) -> Preferences.Key<T>,
  ): T {
  ...
  private inline fun <T> getValueFlow(
    key: String,
    defaultValue: T,
    crossinline keyCreator: (String) -> Preferences.Key<T>,
  ): Flow<T> {
